...
[![Build Status](https://travis-ci.org/moveability/moveability.svg)](https://travis-ci.org/moveability/moveability) 
[![AppVeyor Build Status](https://ci.appveyor.com/api/projects/status/github/moveability/moveability?branch=master&svg=true)](https://ci.appveyor.com/project/moveability/moveability)
...
An alternative approach is to pre-download the network and submit that to the
`moveability()` function:
```{r, eval = FALSE}
