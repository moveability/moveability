...
rcpp_get_sp_dists_par <- function(graph, vert_map_in, fromi, toi, heap_type) {
    .Call(`_moveability_rcpp_get_sp_dists_par`, graph, vert_map_in, fromi, toi, heap_type)
}
...
rcpp_get_sp_dists <- function(graph, vert_map_in, fromi, toi, heap_type) {
    .Call(`_moveability_rcpp_get_sp_dists`, graph, vert_map_in, fromi, toi, heap_type)
}
